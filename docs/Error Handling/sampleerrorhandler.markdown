 ...
 * Using the method {@link module:controller/ErrorHandler#addModelToHandle} it is possible to activate the error handling for further models in addition to the default model.<br>
